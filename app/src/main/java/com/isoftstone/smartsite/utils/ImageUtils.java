...
import com.isoftstone.smartsite.widgets.CircleImageTransform;
...
public class ImageUtils {
     ...
     * @param imageUrl   图片地址
     */
    public static void loadImageWithPlaceHolder2 (Context context, ImageView imageView, String imageUrl, int resId) {
        Glide.with(context)
                .load(imageUrl)
                //.placeholder(R.mipmap.pic_loading)
                .error(resId)
     ...
     * @param imageUrl   图片地址
     */
    public static void loadImageWithPlaceHolderLoading(Context context, ImageView imageView, String imageUrl, int resId) {
        Glide.with(context)
                .load(imageUrl)
                .placeholder(R.mipmap.pic_loading)
                .error(resId)
    ...
    public static void loadFromBytes(Activity activity,Byte[] bytes,ImageView imageView){
        Glide.with(activity).load(bytes).into(imageView);
    }

    public static void loadFromBytes(Fragment fragment,Byte[] bytes,ImageView imageView){
        Glide.with(fragment).load(bytes).into(imageView);
    }

    public static void loadFromRes(Activity activity, @DrawableRes int resId, ImageView imageView){
        Glide.with(activity).load(resId).into(imageView);
    }

    public static void loadFromRes(Fragment fragment, @DrawableRes int resId, ImageView imageView){
